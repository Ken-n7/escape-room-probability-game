...
> This is a detailed companion to the short `README.md`. It documents the architecture, gameplay systems, data model, and setup in depth. Nothing else in the repository is modified.
...
- `docs/design-exploration-rooms-and-hunting.md` — level-design study (Slendrina, Granny, Amnesia/Outlast references), the interleaved-room layout proposal, and note-hunting design.
